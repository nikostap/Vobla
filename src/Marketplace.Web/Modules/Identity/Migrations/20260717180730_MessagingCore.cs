...
{
    /// <inheritdoc />
    public partial class MessagingCore : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AutoReplySettings", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsArchivedBySeller = table.Column<bool>(type: "boolean", nullable: false),
                    IsArchivedByBuyer = table.Column<bool>(type: "boolean", nullable: false),
                    CreatedAt = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: false),
                    UpdatedAt = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: false)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OriginalName = table.Column<string>(type: "character varying(240)", maxLength: 240, nullable: false),
                    StorageKey = table.Column<string>(type: "character varying(500)", maxLength: 500, nullable: false),
                    MimeType = table.Column<string>(type: "character varying(120)", maxLength: 120, nullable: false),
                    Size = table.Column<long>(type: "bigint", nullable: false),
                    SafetyStatus = table.Column<string>(type: "character varying(24)", maxLength: 24, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AutoReplySettings_OwnerId_ListingId",
                table: "AutoReplySettings",
                columns: new[] { "OwnerId", "ListingId" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ChatBlocks_ConversationId_BlockerId_BlockedId",
                table: "ChatBlocks",
                columns: new[] { "ConversationId", "BlockerId", "BlockedId" },
                unique: true);
