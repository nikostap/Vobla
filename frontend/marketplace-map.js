...
async function initializeMap(shell) {
  ...
  const styleFor = config => {
    ...
    const mapLayers = [
      ...
      { id: "buildings", type: "fill", ...source, "source-layer": "buildings", minzoom: 13, paint: { "fill-color": flavor.buildings, "fill-opacity": 0.5 } },
      ...
      { id: "house-numbers", type: "symbol", ...source, "source-layer": "housenumber", filter: ["!=", ["get", "housenumber"], null], minzoom: 14, layout: { "text-field": ["get", "housenumber"], "text-font": ["Noto Sans Regular"], "text-size": 10 }, paint: { "text-color": flavor.address_label, "text-halo-color": flavor.address_label_halo, "text-halo-width": 1 } }
    ];
